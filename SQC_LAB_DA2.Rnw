...
\textbf{Title- U Chart and C Chart}\\
\textbf{Exercise No. 1}\\
\textbf{Reg No.} : 23MDT0047\\
\textbf{Date} : November 13, 2024 \\
\textbf{Aim} : To Check U chart and C Chart of the Paper Data \\
...
@
\textbf {Conclusion:} \\
The process can be considered in control, and no immediate changes are necessary. C and U charts. \\
------------------------------------------------------------------------------ \\
\textbf{Title- U Chart and C Chart}\\
\textbf{Exercise No. 2}\\
\textbf{Reg No.} : 23MDT0047\\
\textbf{Date} : November 13, 2024 \\
\textbf{Aim} : To Check U chart and C Chart of the Data \\
\textbf{Data Description} : Paper Data. It consists of two columns - X and 
S.No \\
